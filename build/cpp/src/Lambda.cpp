...
HX_LOCAL_STACK_FRAME(_hx_pos_5a5335a44f209143_183_fold,"Lambda","fold",0x9b8816a8,"Lambda.fold","C:\\Tools\\HaxeToolkit\\haxe\\std/Lambda.hx",183,0x73b6647f)
...
bool Lambda_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Lambda_obj::fold( ::Dynamic it, ::Dynamic f, ::Dynamic first){
            	HX_STACKFRAME(&_hx_pos_5a5335a44f209143_183_fold)
HXLINE( 184)		{
