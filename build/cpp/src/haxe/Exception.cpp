...
HX_DEFINE_STACK_FRAME(_hx_pos_58c7c9525bc07d1a_5_new,"haxe.Exception","new",0xa32fba59,"haxe.Exception.new","C:\\Tools\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/Exception.hx",5,0xc31c4171)
HX_LOCAL_STACK_FRAME(_hx_pos_58c7c9525bc07d1a_75_get_native,"haxe.Exception","get_native",0xdd187087,"haxe.Exception.get_native","C:\\Tools\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/Exception.hx",75,0xc31c4171)
HX_LOCAL_STACK_FRAME(_hx_pos_58c7c9525bc07d1a_27_thrown,"haxe.Exception","thrown",0x8e12fc2f,"haxe.Exception.thrown","C:\\Tools\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/Exception.hx",27,0xc31c4171)
namespace haxe{

void Exception_obj::__construct(::String message, ::haxe::Exception previous, ::Dynamic native){
            	HX_STACKFRAME(&_hx_pos_58c7c9525bc07d1a_5_new)
...
bool Exception_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Exception_obj::get_native(){
            	HX_STACKFRAME(&_hx_pos_58c7c9525bc07d1a_75_get_native)
...
HX_DEFINE_DYNAMIC_FUNC0(Exception_obj,get_native,return )
 ...
 ::Dynamic Exception_obj::thrown( ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_58c7c9525bc07d1a_27_thrown)
