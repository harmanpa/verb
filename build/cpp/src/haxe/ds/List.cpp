...
HX_DEFINE_STACK_FRAME(_hx_pos_885f7c4224a7af4c_45_new,"haxe.ds.List","new",0x82be24e7,"haxe.ds.List.new","C:\\Tools\\HaxeToolkit\\haxe\\std/haxe/ds/List.hx",45,0x3f1ebe51)
HX_LOCAL_STACK_FRAME(_hx_pos_885f7c4224a7af4c_53_add,"haxe.ds.List","add",0x82b446a8,"haxe.ds.List.add","C:\\Tools\\HaxeToolkit\\haxe\\std/haxe/ds/List.hx",53,0x3f1ebe51)
namespace haxe{
namespace ds{

void List_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_885f7c4224a7af4c_45_new)
...
void List_obj::add( ::Dynamic item){
            	HX_GC_STACKFRAME(&_hx_pos_885f7c4224a7af4c_53_add)
