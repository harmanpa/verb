...
HX_DEFINE_STACK_FRAME(_hx_pos_c4da2f98c828cfbc_266_new,"haxe.ds._List.ListNode","new",0x5847787a,"haxe.ds._List.ListNode.new","C:\\Tools\\HaxeToolkit\\haxe\\std/haxe/ds/List.hx",266,0x3f1ebe51)
namespace haxe{
namespace ds{
namespace _List{

void ListNode_obj::__construct( ::Dynamic item, ::haxe::ds::_List::ListNode next){
            	HX_STACKFRAME(&_hx_pos_c4da2f98c828cfbc_266_new)
