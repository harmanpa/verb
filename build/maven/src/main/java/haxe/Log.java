...
public class Log extends haxe.lang.HxObject
{
	static
	{
		//line 62 "C:\\Tools\\HaxeToolkit\\haxe\\std\\haxe\\Log.hx"
	...
	public Log()
	{
		//line 29 "C:\\Tools\\HaxeToolkit\\haxe\\std\\haxe\\Log.hx"
	...
	{
		//line 34 "C:\\Tools\\HaxeToolkit\\haxe\\std\\haxe\\Log.hx"
		java.lang.String str = haxe.root.Std.string(v);
		//line 35 "C:\\Tools\\HaxeToolkit\\haxe\\std\\haxe\\Log.hx"
		if (( infos == null )) 
		{
			//line 36 "C:\\Tools\\HaxeToolkit\\haxe\\std\\haxe\\Log.hx"
			return str;
		}
		
		//line 37 "C:\\Tools\\HaxeToolkit\\haxe\\std\\haxe\\Log.hx"
		...
		//line 38 "C:\\Tools\\HaxeToolkit\\haxe\\std\\haxe\\Log.hx"
		if (( ((haxe.root.Array) (haxe.lang.Runtime.getField(infos, "customParams", true)) ) != null )) 
		{
			//line 39 "C:\\Tools\\HaxeToolkit\\haxe\\std\\haxe\\Log.hx"
			int _g = 0;
			//line 39 "C:\\Tools\\HaxeToolkit\\haxe\\std\\haxe\\Log.hx"
			...
			while (( _g < _g1.length ))
			{
				...
				//line 39 "C:\\Tools\\HaxeToolkit\\haxe\\std\\haxe\\Log.hx"
				 ++ _g;
				//line 40 "C:\\Tools\\HaxeToolkit\\haxe\\std\\haxe\\Log.hx"
				str += ( ", " + haxe.root.Std.string(v1) );
			}
			
		}
		
		//line 41 "C:\\Tools\\HaxeToolkit\\haxe\\std\\haxe\\Log.hx"
		return ( ( pstr + ": " ) + str );
	}
