...
public class StringRefl
{
	static
	{
		//line 204 "C:\\Tools\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
	...
	{
		//line 209 "C:\\Tools\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
		{
			//line 209 "C:\\Tools\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
				...
				switch (__temp_hash3)
				{
					case -1106363674:
					{
						...
						if (__temp_svar1.equals("length")) 
						{
							...
							//line 211 "C:\\Tools\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
							return str.length();
						}
					...
					case -1361633751:
					{
						...
						if (( (( ( __temp_hash3 == -399551817 ) && __temp_svar1.equals("toUpperCase") )) || ( (( ( __temp_hash3 == -1137582698 ) && __temp_svar1.equals("toLowerCase") )) || ( (( ( __temp_hash3 == 530542161 ) && __temp_svar1.equals("substring") )) || ( (( ( __temp_hash3 == -891529231 ) && __temp_svar1.equals("substr") )) || ( (( ( __temp_hash3 == 109648666 ) && __temp_svar1.equals("split") )) || ( (( ( __temp_hash3 == -467511597 ) && __temp_svar1.equals("lastIndexOf") )) || ( (( ( __temp_hash3 == 1943291465 ) && __temp_svar1.equals("indexOf") )) || ( (( ( __temp_hash3 == 397153782 ) && __temp_svar1.equals("charCodeAt") )) || __temp_svar1.equals("charAt") ) ) ) ) ) ) ) )) 
						{
							//line 209 "C:\\Tools\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
							__temp_executeDef2 = false;
							//line 213 "C:\\Tools\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
			...
			//line 215 "C:\\Tools\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
			if (__temp_executeDef2) 
			{
				//line 215 "C:\\Tools\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
				if (throwErrors) 
				{
					//line 216 "C:\\Tools\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
					throw ((java.lang.RuntimeException) (haxe.Exception.thrown(( ( "Field not found: \'" + f ) + "\' in String" ))) );
				}
				else
				{
					//line 218 "C:\\Tools\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
					return null;
				}
	...
	{
		//line 223 "C:\\Tools\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
		java.lang.Object[] _args = null;
		//line 224 "C:\\Tools\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
		if (( args == null )) 
		{
			//line 225 "C:\\Tools\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
			_args = ((java.lang.String[]) (new java.lang.String[]{haxe.lang.Runtime.toString(str)}) );
		}
		else
		{
			//line 227 "C:\\Tools\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
			_args = new java.lang.Object[( args.length + 1 )];
			//line 228 "C:\\Tools\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
			_args[0] = str;
			//line 229 "C:\\Tools\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
			{
				//line 229 "C:\\Tools\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
				int _g = 0;
				//line 229 "C:\\Tools\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
				...
				while (( _g < _g1 ))
				{
					//line 229 "C:\\Tools\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
					int i = _g++;
					//line 230 "C:\\Tools\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
					_args[( i + 1 )] = args[i];
				}
		...
		//line 232 "C:\\Tools\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
