...
public class Lambda extends haxe.lang.HxObject
{
	...
	public Lambda()
	{
		//line 39 "C:\\Tools\\HaxeToolkit\\haxe\\std\\Lambda.hx"
	...
	{
		//line 184 "C:\\Tools\\HaxeToolkit\\haxe\\std\\Lambda.hx"
		{
			//line 184 "C:\\Tools\\HaxeToolkit\\haxe\\std\\Lambda.hx"
			...
			while (haxe.lang.Runtime.toBool(((java.lang.Boolean) (haxe.lang.Runtime.callField(x, "hasNext", null)) )))
			{
				...
				//line 185 "C:\\Tools\\HaxeToolkit\\haxe\\std\\Lambda.hx"
				first = ((B) (f.__hx_invoke2_o(0.0, x1, 0.0, first)) );
			}
			
		}
		
		//line 186 "C:\\Tools\\HaxeToolkit\\haxe\\std\\Lambda.hx"
		return first;
	}
