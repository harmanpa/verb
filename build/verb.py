...
class verb_core_ArrayExtensions:
    ...
    def unique(arr,comp):
        ...
        if (len(arr) == 0):
            return uniques
        x = (None if ((len(arr) == 0)) else arr.pop())
        uniques.append(x)
        while (len(arr) > 0):
...
class verb_core_BinaryHeap_verb_core_KdNode_verb_core_MeshIntersectionPoint:
    _hx_class_name = "verb.core.BinaryHeap_verb_core_KdNode_verb_core_MeshIntersectionPoint"
...
verb_core_BinaryHeap_verb_core_KdNode_verb_core_MeshIntersectionPoint._hx_class = verb_core_BinaryHeap_verb_core_KdNode_verb_core_MeshIntersectionPoint
_hx_classes["verb.core.BinaryHeap_verb_core_KdNode_verb_core_MeshIntersectionPoint"] = verb_core_BinaryHeap_verb_core_KdNode_verb_core_MeshIntersectionPoint
...
class verb_core_HeapElement_verb_core_KdNode_verb_core_MeshIntersectionPoint:
    _hx_class_name = "verb.core.HeapElement_verb_core_KdNode_verb_core_MeshIntersectionPoint"
    __slots__ = ("obj", "value")
    _hx_fields = ["obj", "value"]
    ...
    def _hx_empty_init(_hx_o):
        _hx_o.obj = None
        _hx_o.value = None
verb_core_HeapElement_verb_core_KdNode_verb_core_MeshIntersectionPoint._hx_class = verb_core_HeapElement_verb_core_KdNode_verb_core_MeshIntersectionPoint
_hx_classes["verb.core.HeapElement_verb_core_KdNode_verb_core_MeshIntersectionPoint"] = verb_core_HeapElement_verb_core_KdNode_verb_core_MeshIntersectionPoint


class verb_core_HeapElement_verb_core_KdPoint_verb_core_MeshIntersectionPoint:
    _hx_class_name = "verb.core.HeapElement_verb_core_KdPoint_verb_core_MeshIntersectionPoint"
    __slots__ = ("obj", "value")
    _hx_fields = ["obj", "value"]
    ...
    def _hx_empty_init(_hx_o):
        _hx_o.obj = None
        _hx_o.value = None
verb_core_HeapElement_verb_core_KdPoint_verb_core_MeshIntersectionPoint._hx_class = verb_core_HeapElement_verb_core_KdPoint_verb_core_MeshIntersectionPoint
_hx_classes["verb.core.HeapElement_verb_core_KdPoint_verb_core_MeshIntersectionPoint"] = verb_core_HeapElement_verb_core_KdPoint_verb_core_MeshIntersectionPoint
...
class verb_core_KdNode_verb_core_MeshIntersectionPoint:
    _hx_class_name = "verb.core.KdNode_verb_core_MeshIntersectionPoint"
...
verb_core_KdNode_verb_core_MeshIntersectionPoint._hx_class = verb_core_KdNode_verb_core_MeshIntersectionPoint
_hx_classes["verb.core.KdNode_verb_core_MeshIntersectionPoint"] = verb_core_KdNode_verb_core_MeshIntersectionPoint


class verb_core_KdPoint_verb_core_MeshIntersectionPoint:
    _hx_class_name = "verb.core.KdPoint_verb_core_MeshIntersectionPoint"
    __slots__ = ("point", "obj")
    ...
    def _hx_empty_init(_hx_o):
        _hx_o.point = None
        _hx_o.obj = None
verb_core_KdPoint_verb_core_MeshIntersectionPoint._hx_class = verb_core_KdPoint_verb_core_MeshIntersectionPoint
_hx_classes["verb.core.KdPoint_verb_core_MeshIntersectionPoint"] = verb_core_KdPoint_verb_core_MeshIntersectionPoint
    ...
    def nearest(self,point,maxNodes,maxDistance):
        ...
        def _hx_local_2(node):
            ...
            def _hx_local_1(node,distance):
                bestNodes.push(verb_core_HeapElement(node,distance))
            ...
            if ((node.right is None) and ((node.left is None))):
                if ((bestNodes.size() < maxNodes) or ((ownDistance < bestNodes.peek().value))):
            ...
            if ((bestNodes.size() < maxNodes) or ((ownDistance < bestNodes.peek().value))):
                saveNode(node,ownDistance)
            if ((bestNodes.size() < maxNodes) or ((Reflect.field(Math,"fabs")(linearDistance) < bestNodes.peek().value))):
        ...
        while (_g < _g1):
            i = _g
            _g = (_g + 1)
            bestNodes.push(verb_core_HeapElement(None,maxDistance))
        ...
        while (_g < _g1):
            i = _g
            _g = (_g + 1)
            if ((bestNodes.content[i] if i >= 0 and i < len(bestNodes.content) else None).obj is not None):
                x = verb_core_HeapElement((bestNodes.content[i] if i >= 0 and i < len(bestNodes.content) else None).obj.kdPoint,(bestNodes.content[i] if i >= 0 and i < len(bestNodes.content) else None).value)
                result.append(x)
        return result
...
class verb_core_HeapElement:
    _hx_class_name = "verb.core.HeapElement"
    __slots__ = ("obj", "value")
    _hx_fields = ["obj", "value"]
    ...
    def _hx_empty_init(_hx_o):
        _hx_o.obj = None
        _hx_o.value = None
verb_core_HeapElement._hx_class = verb_core_HeapElement
_hx_classes["verb.core.HeapElement"] = verb_core_HeapElement
...
class verb_core_KdTree_verb_core_MeshIntersectionPoint:
    _hx_class_name = "verb.core.KdTree_verb_core_MeshIntersectionPoint"
    __slots__ = ("points", "distanceFunction", "dim", "root")
    _hx_fields = ["points", "distanceFunction", "dim", "root"]
    _hx_methods = ["buildTree", "nearest"]
    ...
    def buildTree(self,points,depth,parent):
        ...
        if (len(points) == 0):
            return None
        if (len(points) == 1):
            return verb_core_KdNode_verb_core_MeshIntersectionPoint((points[0] if 0 < len(points) else None),dim,parent)
        def _hx_local_0(a,b):
            diff = ((a.point[dim] if dim >= 0 and dim < len(a.point) else None) - (b.point[dim] if dim >= 0 and dim < len(b.point) else None))
            if (diff == 0.0):
                return 0
        ...
        points.sort(key= python_lib_Functools.cmp_to_key(_hx_local_0))
        median = Math.floor((len(points) / 2))
        node = verb_core_KdNode_verb_core_MeshIntersectionPoint((points[median] if median >= 0 and median < len(points) else None),dim,parent)
        node.left = self.buildTree(points[0:median],(depth + 1),node)
        node.right = self.buildTree(points[(median + 1):None],(depth + 1),node)
        return node
    ...
    def nearest(self,point,maxNodes,maxDistance):
        ...
        def _hx_local_0(e):
            return -e.value
        bestNodes = verb_core_BinaryHeap_verb_core_KdNode_verb_core_MeshIntersectionPoint(_hx_local_0)
        nearestSearch = None
        def _hx_local_2(node):
            bestChild = None
            dimension = node.dimension
            ...
            i = None
            def _hx_local_1(node,distance):
                bestNodes.push(verb_core_HeapElement_verb_core_KdNode_verb_core_MeshIntersectionPoint(node,distance))
                if (bestNodes.size() > maxNodes):
                    bestNodes.pop()
            saveNode = _hx_local_1
            _g = 0
        ...
        while (_g < _g1):
            i = _g
            _g = (_g + 1)
            bestNodes.push(verb_core_HeapElement_verb_core_KdNode_verb_core_MeshIntersectionPoint(None,maxDistance))
        nearestSearch(self.root)
        result = list()
        _g = 0
        _g1 = maxNodes
        while (_g < _g1):
            ...
            _g = (_g + 1)
            if ((bestNodes.content[i] if i >= 0 and i < len(bestNodes.content) else None).obj is not None):
                x = verb_core_HeapElement_verb_core_KdPoint_verb_core_MeshIntersectionPoint((bestNodes.content[i] if i >= 0 and i < len(bestNodes.content) else None).obj.kdPoint,(bestNodes.content[i] if i >= 0 and i < len(bestNodes.content) else None).value)
                result.append(x)
        return result
    ...
    def _hx_empty_init(_hx_o):
        ...
        _hx_o.dim = None
        _hx_o.root = None
verb_core_KdTree_verb_core_MeshIntersectionPoint._hx_class = verb_core_KdTree_verb_core_MeshIntersectionPoint
_hx_classes["verb.core.KdTree_verb_core_MeshIntersectionPoint"] = verb_core_KdTree_verb_core_MeshIntersectionPoint
...
class verb_core_Mat:
    ...
    __slots__ = ()
    _hx_statics = ["mul", "mult", "add", "div", "sub", "dot", "identity", "transpose", "transposeN", "solve", "LUsolve", "LU"]
...
class verb_eval_Analyze:
    ...
    def isRationalSurfaceClosed(surface,uDir = None):
        if (uDir is None):
            uDir = True
        cpts = (surface.controlPoints if uDir else verb_core_Mat.transposeN(surface.controlPoints))
        _g = 0
...
class verb_eval_Eval:
    ...
    def homogenize1d(controlPoints,weights = None):
        ...
        wt = 0.0
        ref_pt = list()
        weights1 = (weights if ((weights is not None)) else verb_core_Vec.fill(len(controlPoints),1.0))
        _g = 0
        _g1 = rows
        while (_g < _g1):
            i = _g
    ...
    def homogenize2d(controlPoints,weights = None):
        ...
        if (weights is not None):
            ...
            while (_g1 < _g2):
                i = _g1
                _g1 = (_g1 + 1)
                x = verb_core_Vec.fill(len((controlPoints[0] if 0 < len(controlPoints) else None)),1.0)
                _g.append(x)
            weights1 = _g
        _g = 0
        _g1 = rows
...
class verb_eval_Intersect:
    ...
    def kdTreeFromSegments(segments):
        ...
        while (_g < len(segments)):
            seg = (segments[_g] if _g >= 0 and _g < len(segments) else None)
            _g = (_g + 1)
            x = verb_core_KdPoint_verb_core_MeshIntersectionPoint(seg.min.point,seg.min)
            treePoints.append(x)
            x1 = verb_core_KdPoint_verb_core_MeshIntersectionPoint(seg.max.point,seg.max)
            treePoints.append(x1)
        return verb_core_KdTree_verb_core_MeshIntersectionPoint(treePoints,verb_core_Vec.distSquared)
    ...
    def curveAndSurfaceWithEstimate(curve,surface,start_params,tol = None):
        ...
        return verb_core_CurveSurfaceIntersection((finalSolution[0] if 0 < len(finalSolution) else None),[(finalSolution[1] if 1 < len(finalSolution) else None), (finalSolution[2] if 2 < len(finalSolution) else None)],verb_eval_Eval.rationalCurvePoint(curve,(finalSolution[0] if 0 < len(finalSolution) else None)),verb_eval_Eval.rationalSurfacePoint(surface,(finalSolution[1] if 1 < len(finalSolution) else None),(finalSolution[2] if 2 < len(finalSolution) else None)))
...
class verb_eval_Tess:
    ...
    def rationalCurveRegularSampleRange(curve,start,end,numSamples,includeU):
        ...
        while (_g < _g1):
            ...
            if includeU:
                uVec = [u]
                x = (uVec + verb_eval_Eval.rationalCurvePoint(curve,u))
                p.append(x)
            else:
...
class verb_geom_NurbsCurve(verb_core_SerializableBase):
    ...
    __slots__ = ("_data",)
    _hx_fields = ["_data"]
    _hx_methods = ["degree", "knots", "controlPoints", "weights", "asNurbs", "clone", "domain", "transform", "point", "tangent", "derivatives", "closestPoint", "closestParam", "length", "lengthAtParam", "paramAtLength", "divideByEqualArcLength", "divideByArcLength", "split", "reverse", "tessellate"]
...
class verb_geom_NurbsSurface(verb_core_SerializableBase):
    ...
    __slots__ = ("_data",)
    _hx_fields = ["_data"]
    _hx_methods = ["degreeU", "degreeV", "knotsU", "knotsV", "controlPoints", "weights", "asNurbs", "clone", "domainU", "domainV", "point", "normal", "derivatives", "closestParam", "closestPoint", "split", "reverse", "isocurve", "boundaries", "tessellate", "transform"]
...
class verb_geom_Intersect:
    ...
    __slots__ = ()
    _hx_statics = ["curves", "curveAndSurface", "surfaces"]
